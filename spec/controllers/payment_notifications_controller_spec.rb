...
def params
  { "mc_gross"=>"30.00", "invoice"=>"5000", "protection_eligibility"=>"Ineligible", "payer_id"=>"LKDFJL3820", "tax"=>"0.00", "payment_date"=>"14:37:48 Mar 03, 2015 PST", "payment_status"=>"Completed",
              ...
              "payer_email"=>"testing@gmail.com", "txn_id"=>"LKSDJFLSDF", "payment_type"=>"instant", "btn_id"=>"0987897", "last_name"=>"Grr", "receiver_email"=>"tester@asu.edu", "payment_fee"=>"1.17",
              "shipping_discount"=>"0.00", "insurance_amount"=>"0.00", "receiver_id"=>"ASLKJF", "txn_type"=>"web_accept", "item_name"=>"DISC Fall 2014 Membership Dues 1 Semester", "discount"=>"0.00",
              "mc_currency"=>"USD", "item_number"=>"", "residence_country"=>"US", "handling_amount"=>"0.00", "shipping_method"=>"Default", "transaction_subject"=>"40",
              "payment_gross"=>"30.00", "shipping"=>"0.00", "ipn_track_id"=>"alsdkfaj1234" }
end
